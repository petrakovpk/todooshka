...
install_xcframework "${PODS_ROOT}/YandexMobileMetrica/dynamic/YandexMobileMetricaCrashes.xcframework" "YandexMobileMetrica/Dynamic/Crashes" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
