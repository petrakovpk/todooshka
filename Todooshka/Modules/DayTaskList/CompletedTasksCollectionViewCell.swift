...
class CompletedTasksCollectionViewCell: SwipeCollectionViewCell {

    // MARK: - Properties
    var disposeBag = DisposeBag()
    var viewModel: CompletedTasksCollectionViewCellModel!

    static var reuseID: String = "CompletedTasksCollectionViewCell"
    ...
    func bindToViewModel(viewModel: CompletedTasksCollectionViewCellModel) {
