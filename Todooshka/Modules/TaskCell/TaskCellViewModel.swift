...
//      .map { _ in self.task.timeLeftText }
//      .startWith( task.timeLeftText )
...
//        if case .RemoveTask(_) = removeMode { return false } else { return true }
//      }
...
//      } else {
//        self.services.tasksService.removeTrigger.accept(.RemoveTask(task: self.task))
//      }
//    }
//    
