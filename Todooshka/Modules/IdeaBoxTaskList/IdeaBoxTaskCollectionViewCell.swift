//
//  IdeaBoxTaskCollectionViewCell.swift
//  Todooshka
//
...
class IdeaBoxTaskCollectionViewCell: SwipeCollectionViewCell {

    //MARK: - Properties
    var disposeBag = DisposeBag()
    var viewModel: IdeaBoxTaskCollectionViewCellModel!
    
    static var reuseID: String = "IdeaBoxTaskCollectionViewCell"
    ...
    func bindToViewModel(viewModel: IdeaBoxTaskCollectionViewCellModel) {
