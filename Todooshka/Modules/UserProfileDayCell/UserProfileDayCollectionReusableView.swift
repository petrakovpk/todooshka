//
//  UserProfileDayCollectionReusableView.swift
//  Todooshka
//
...
class UserProfileDayCollectionReusableView: UICollectionReusableView {
    
    static var reuseID: String = "UserProfileDayCollectionReusableView"
