//
//  DeletedTasksCollectionViewCell.swift
//  Todooshka
//
...
class DeletedTasksCollectionViewCell: SwipeCollectionViewCell {

    //MARK: - Properties
    var disposeBag = DisposeBag()
    var viewModel: DeletedTasksCollectionViewCellModel!
    
    static var reuseID: String = "DeletedTasksCollectionViewCell"
    ...
    func bindToViewModel(viewModel: DeletedTasksCollectionViewCellModel) {
