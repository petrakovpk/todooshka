...
class DeletedTasksListViewController: UIViewController {
  ...
  private func configureAlert() {
    ...
    let alertLabel = UILabel(text: "Удалить ВСЕ задачи?")
  ...
  func bindTo(with viewModel: DeletedTasksListViewModel) {
    ...
    removeAllButton.rx.tapGesture().when(.recognized).bind { _ in viewModel.removeAllTasksButtonClick() }.disposed(by: disposeBag)
