...
class QuestCategoryCell: UICollectionViewCell {
  static var reuseID: String = "QuestCategoryCell"

  private let shapeLayer = CAShapeLayer()
  private var oldShapeLayer: CAShapeLayer?
  
  private var questCategoryImageView: UIImageView = {
  ...
  func configure(with item: PublicKindItem) {
    ...
    case .empty:
      questCategoryImageView.image = nil
      textLabel.text = "Без категории"
    case .kind(let kind):
      questCategoryImageView.image = kind.image
