...
class TypeSmallCollectionViewCell: UICollectionViewCell {
  ...
  // MARK: - Configure
  func configure(with type: TaskType, isSelected: Bool) {
    ...
    imageView.tintColor = isSelected ? Theme.TypeSmallCollectionViewCell.selectedTint : type.color.uiColor
    
    // shapeLayer
    shapeLayer.fillColor = isSelected ? Theme.TypeSmallCollectionViewCell.selectedBackground?.cgColor : Theme.TypeSmallCollectionViewCell.unselectedBackground?.cgColor
  }
}
