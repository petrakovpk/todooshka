//
//  QuestKindPresentationViewController.swift
//  DragoDo
//
...
class QuestCategoryPresentationViewController: UIViewController {
  public var viewModel: QuestCategoryPresentationViewModel!
  ...
  func configureUI() {
    ...
    collectionView.register(QuestCategoryCell.self, forCellWithReuseIdentifier: QuestCategoryCell.reuseID)
  ...
  func bindViewModel() {
    let input = QuestCategoryPresentationViewModel.Input(
    ...
    [
      outputs.questCategorySections.drive(collectionView.rx.items(dataSource: dataSource)),
