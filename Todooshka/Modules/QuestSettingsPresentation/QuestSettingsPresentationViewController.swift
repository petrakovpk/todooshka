//
//  QuestPresentationViewController.swift
//  DragoDo
//
...
class QuestSettingsPresentationViewController: UIViewController {
  public var viewModel: QuestSettingsPresentationViewModel!
  ...
  func bindViewModel() {
    let input = QuestSettingsPresentationViewModel.Input(
